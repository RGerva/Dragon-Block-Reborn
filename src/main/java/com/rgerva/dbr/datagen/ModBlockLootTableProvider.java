/**
 * Generic Class: ModBlockLootTableProvider <T>
...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        dropSelf(ModBlocks.GETE_BLOCK.get());
        dropSelf(ModBlocks.GETE_ORE.get());
        dropSelf(ModBlocks.KIKONO_BLOCK.get());
        dropSelf(ModBlocks.NAMEK_KIKONO_ORE.get());
    }
