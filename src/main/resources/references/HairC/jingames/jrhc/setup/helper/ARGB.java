...
public class ARGB {
   ...
   public static int multiply(int p_368908_, int p_362670_) {
      if (p_368908_ == -1) {
         ...
         return p_362670_ == -1 ? p_368908_ : color(alpha(p_368908_) * alpha(p_362670_) / 255, red(p_368908_) * red(p_362670_) / 255, green(p_368908_) * green(p_362670_) / 255, blue(p_368908_) * blue(p_362670_) / 255);
      }
   }
   ...
   public static int scaleRGB(int p_368386_, float p_366859_, float p_367328_, float p_364459_) {
      return color(alpha(p_368386_), Math.clamp((long)((int)((float)red(p_368386_) * p_366859_)), 0, 255), Math.clamp((long)((int)((float)green(p_368386_) * p_367328_)), 0, 255), Math.clamp((long)((int)((float)blue(p_368386_) * p_364459_)), 0, 255));
   }

   public static int scaleRGB(int p_366038_, int p_368003_) {
      return color(alpha(p_366038_), Math.clamp((long)red(p_366038_) * (long)p_368003_ / 255L, 0, 255), Math.clamp((long)green(p_366038_) * (long)p_368003_ / 255L, 0, 255), Math.clamp((long)blue(p_366038_) * (long)p_368003_ / 255L, 0, 255));
   }
   ...
   public static int average(int p_368446_, int p_366831_) {
      return color((alpha(p_368446_) + alpha(p_366831_)) / 2, (red(p_368446_) + red(p_366831_)) / 2, (green(p_368446_) + green(p_366831_)) / 2, (blue(p_368446_) + blue(p_366831_)) / 2);
   }
   ...
   public static int toABGR(int p_368147_) {
      return p_368147_ & -16711936 | (p_368147_ & 16711680) >> 16 | (p_368147_ & 255) << 16;
   }
