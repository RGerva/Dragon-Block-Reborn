...
public class FastColor {
   ...
   public static class ARGB32 {
      ...
      public static int average(int p_343274_, int p_343634_) {
         return color((alpha(p_343274_) + alpha(p_343634_)) / 2, (red(p_343274_) + red(p_343634_)) / 2, (green(p_343274_) + green(p_343634_)) / 2, (blue(p_343274_) + blue(p_343634_)) / 2);
      }
   }
   ...
   public static class ABGR32 {
      ...
      public static int fromArgb32(int p_342962_) {
         return p_342962_ & -16711936 | (p_342962_ & 16711680) >> 16 | (p_342962_ & 255) << 16;
      }
   }
}
