...
public class ButtonA2 extends AbstractWidgetA2 {
   public static final ButtonA2.OnTooltip NO_TOOLTIP = (p_93740_, p_93741_, p_93742_, p_93743_) -> {
   };
   protected final ButtonA2.OnPress onPress;
   protected final ButtonA2.OnTooltip onTooltip;

   public ButtonA2(int p_93721_, int p_93722_, int p_93723_, int p_93724_, Component p_93725_, ButtonA2.OnPress p_93726_, int hideGroup) {
      this(p_93721_, p_93722_, p_93723_, p_93724_, p_93725_, p_93726_, NO_TOOLTIP, hideGroup);
   }

   public ButtonA2(int p_93728_, int p_93729_, int p_93730_, int p_93731_, Component p_93732_, ButtonA2.OnPress p_93733_, ButtonA2.OnTooltip p_93734_, int hideGroup) {
      super(p_93728_, p_93729_, p_93730_, p_93731_, p_93732_, hideGroup);
      this.onPress = p_93733_;
      this.onTooltip = p_93734_;
   }

   public ButtonA2(int p_93721_, int p_93722_, int p_93723_, int p_93724_, Component p_93725_, ButtonA2.OnPress p_93726_) {
      this(p_93721_, p_93722_, p_93723_, p_93724_, p_93725_, p_93726_, NO_TOOLTIP);
   }

   public ButtonA2(int p_93728_, int p_93729_, int p_93730_, int p_93731_, Component p_93732_, ButtonA2.OnPress p_93733_, ButtonA2.OnTooltip p_93734_) {
   ...
   public interface OnTooltip {
      void onTooltip(ButtonA2 var1, Matrix3x2fStack var2, int var3, int var4);
