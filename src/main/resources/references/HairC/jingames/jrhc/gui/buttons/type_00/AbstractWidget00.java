package jingames.jrhc.gui.buttons.type_00;
...
public abstract class AbstractWidget00 implements Renderable, GuiEventListener, LayoutElement, NarratableEntry {
   ...
   public AbstractWidget00(int p_93629_, int p_93630_, int p_93631_, int p_93632_, Component p_93633_, int tooltip) {
      this.x = p_93629_;
      this.y = p_93630_;
      this.width = p_93631_;
   ...
   public AbstractWidget00(int p_93629_, int p_93630_, int p_93631_, int p_93632_, Component p_93633_, int bgColor, int tooltip) {
      this.x = p_93629_;
      this.y = p_93630_;
      this.width = p_93631_;
      this.height = p_93632_;
   ...
   public void renderButton(GuiGraphics gui, int p_93677_, int p_93678_, float p_93679_) {
      if (this.visible) {
         ...
         int j = this.bgCol == 0 ? 16449280 : this.bgCol;
         ...
         int var6;
         if (var5 == 2) {
            fillcolor = (int)(h2 * 254.0F);
            var6 = (int)(h3 * 254.0F);
            int b = (int)(h4 * 254.0F);
            float[] hsb = Color.RGBtoHSB(fillcolor, var6, b, (float[])null);
            float hue = hsb[0];
         ...
         fillcolor = ARGB.colorFromFloat(1.0F, h1 * h2, h1 * h3, h1 * h4);
         gui.blit(RenderPipelines.GUI_TEXTURED, BUTTON_1, this.x, this.y, 0.0F, (float)(46 + var5 * 20), this.width / 2, this.height, 256, 256);
         gui.blit(RenderPipelines.GUI_TEXTURED, BUTTON_1, this.x + this.width / 2, this.y, (float)(200 - this.width / 2), (float)(46 + var5 * 20), this.width / 2, this.height, 256, 256);
         gui.fill(this.x + 2, this.y + 2, this.x + this.width - 2, this.y + this.height - 2, fillcolor);
         this.mouseMoved((double)p_93677_, (double)p_93678_);
         var6 = ARGB.color(255, 224, 224, 224);
         if (!this.active) {
         ...
         gui.nextStratum();
         int k2;
         if (this.isHovered && this.tooltip == 1) {
            k2 = ARGB.color(255, 255, 255, 255);
            gui.fill(p_93677_ - 130, p_93678_ - 40, p_93677_ + 80, p_93678_ - 1, k2);
            GuiHelper.drawString(gui, var4, "It will open the HairSalon site where", p_93677_ - 130 + 4, p_93678_ - 40 + 5, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "you can browse hairstyles from other", p_93677_ - 130 + 4, p_93678_ - 40 + 16, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "users at https://hairsalon.jingames.net", p_93677_ - 130 + 4, p_93678_ - 40 + 27, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
         }

         if (this.isHovered && this.tooltip == 2) {
            k2 = ARGB.color(255, 255, 255, 255);
            gui.fill(p_93677_ - 130, p_93678_ - 49, p_93677_ + 80, p_93678_ - 1, k2);
            GuiHelper.drawString(gui, var4, "It will copy your current hairstyle", p_93677_ - 130 + 4, p_93678_ - 40 - 4, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "code to clipboard to share with others,", p_93677_ - 130 + 4, p_93678_ - 40 + 5, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "mainly meant for the", p_93677_ - 130 + 4, p_93678_ - 40 + 16, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "https://hairsalon.jingames.net", p_93677_ - 130 + 4, p_93678_ - 40 + 27, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
         }

         if (this.isHovered && this.tooltip == 3) {
            k2 = ARGB.color(255, 255, 255, 255);
            gui.fill(p_93677_ - 130, p_93678_ - 29, p_93677_ + 80, p_93678_ - 1, k2);
            GuiHelper.drawString(gui, var4, "It will paste a hairstyle code from", p_93677_ - 130 + 4, p_93678_ - 40 + 16, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "clipboard", p_93677_ - 130 + 4, p_93678_ - 40 + 27, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
         }

         if (this.isHovered && this.tooltip == 4) {
            k2 = ARGB.color(255, 255, 255, 255);
            gui.fill(p_93677_ - 130, p_93678_ - 40, p_93677_ + 80, p_93678_ - 1, k2);
            GuiHelper.drawString(gui, var4, "It will reset the current hairstyle to", p_93677_ - 130 + 4, p_93678_ - 40 + 5, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "the hairstyle preset currently ", p_93677_ - 130 + 4, p_93678_ - 40 + 16, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
            GuiHelper.drawString(gui, var4, "selected", p_93677_ - 130 + 4, p_93678_ - 40 + 27, ARGB.colorFromFloat(1.0F, 0.0F, 0.0F, 0.0F), false);
         }
