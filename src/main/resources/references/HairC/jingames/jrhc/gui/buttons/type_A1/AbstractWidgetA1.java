...
public abstract class AbstractWidgetA1 implements Renderable, GuiEventListener, LayoutElement, NarratableEntry {
   ...
   public AbstractWidgetA1(int p_93629_, int p_93630_, int p_93631_, int p_93632_, Component setThisToEmpty) {
      this.x = p_93629_;
      this.y = p_93630_;
      this.width = 15;
      this.height = 15;
   ...
   public void renderButton(GuiGraphics gui, int p_93677_, int p_93678_, float p_93679_) {
      if (this.visible) {
         ...
         gui.blit(RenderPipelines.GUI_TEXTURED, BUTTON_1, this.x, this.y, (float)huv, (float)(0 + var5 * 15), this.width, this.height, 256, 256);
         gui.fill(0, 0, 0, 0, 0);
         p_93676_.popMatrix();
      }
