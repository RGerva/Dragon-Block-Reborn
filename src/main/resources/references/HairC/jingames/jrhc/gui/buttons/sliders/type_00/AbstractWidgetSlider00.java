...
public abstract class AbstractWidgetSlider00 implements Renderable, GuiEventListener, LayoutElement, NarratableEntry {
   ...
   public AbstractWidgetSlider00(int p_93629_, int p_93630_, int p_93631_, int p_93632_, Component label, float startingValue, float maxValue) {
      this.x = p_93629_;
      this.y = p_93630_;
      this.width = 20;
      this.height = 128;
   ...
   public void renderButton(GuiGraphics gui, int p_93677_, int p_93678_, float p_93679_) {
      if (this.visible) {
         ...
         int k = 0;
         gui.blit(RenderPipelines.GUI_TEXTURED, BUTTON_1, this.x, this.y, (float)(236 - k * 20), 0.0F, this.width, this.height, 256, 256);
         gui.fill(0, 0, 0, 0, 0);
         int l = ARGB.color(255, 224, 224, 224);
         if (!this.active) {
         ...
         gui.blit(RenderPipelines.GUI_TEXTURED, BUTTON_1, this.x, this.y + (int)(this.sliderValue * (float)(this.height - 4)), 216.0F, 0.0F, 20, 2, 256, 256);
         gui.fill(0, 0, 0, 0, 0);
         gui.blit(RenderPipelines.GUI_TEXTURED, BUTTON_1, this.x, this.y + (int)(this.sliderValue * (float)(this.height - 4)) + 2, 216.0F, 126.0F, 20, 2, 256, 256);
         gui.fill(0, 0, 0, 0, 0);
   ...
   protected void onDrag(double p_93636_, double p_93637_, double xpos, double ypos) {
      if (this.visible && this.dragging) {
         this.sliderValue = (float)(p_93637_ - (double)(this.y + 4)) / (float)(this.height - 8);
   ...
   public boolean mouseClicked(double p_93641_, double p_93642_, int p_93643_) {
      if (this.active && this.visible) {
         if (this.isValidClickButton(p_93643_)) {
            ...
            if (flag) {
               this.sliderValue = (float)(p_93642_ - (double)(this.y + 4)) / (float)(this.height - 8);
               if (this.sliderValue < 0.0F) {
                  this.sliderValue = 0.0F;
               }
