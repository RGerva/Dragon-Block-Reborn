...
/*     */   public String tex;
/*  17 */   public final int AttPow = 28000;
/*  18 */   public final int HePo = 128000;
/*     */   private int target;
/*     */   
...
/*  34 */     func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(128000.0D);
/*  35 */     func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(28000.0D);
/*     */   }
...
/*  62 */         int dea = 50;
/*  63 */         EntityZamasu_Fused2 entityZamasu_Fused2 = this;
/*     */ 
/*     */         
...
/*     */ 
/*     */         
/* 113 */         EntityCusPar entityCusPar3 = new EntityCusPar("jinryuumodscore:bens_particles.png", this.field_70170_p, 0.2F, 0.2F, ((Entity)entityZamasu_Fused2).field_70165_t, ((Entity)entityZamasu_Fused2).field_70163_u, ((Entity)entityZamasu_Fused2).field_70161_v, x, y, z, 0.0D, Math.random() * 0.05000000074505806D, 0.0D, 0.0F, (int)(Math.random() * 3.0D) + 8, 8, 3, 32, false, 0.0F, false, 0.0F, 1, "", 50, 2, ((float)(Math.random() * 0.029999999329447746D) + 0.03F) * life * 0.5F, ((float)(Math.random() * 0.009999999776482582D) + 0.02F) * life * 0.5F, 0.2F * life * 0.5F, 0, 140.0F, 8.0F, 62.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 2, 0.0F, 0.0F, 0.4F, 0.45F, 0.015F, false, -1, false, (Entity)entityZamasu_Fused2);
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/*     */ 
/*     */         
/* 130 */         EntityCusPar entityCusPar6 = new EntityCusPar("jinryuudragonbc:bens_particles.png", this.field_70170_p, 0.2F, 0.2F, ((Entity)entityZamasu_Fused2).field_70165_t, ((Entity)entityZamasu_Fused2).field_70163_u, ((Entity)entityZamasu_Fused2).field_70161_v, x, y, z, 0.0D, Math.random() * 0.05000000074505806D, 0.0D, 0.0F, (int)(Math.random() * 8.0D) + 32, 32, 8, 32, false, 0.0F, false, 0.0F, 1, "", 50, 2, ((float)(Math.random() * 0.029999999329447746D) + 0.03F) * life * 0.5F, ((float)(Math.random() * 0.009999999776482582D) + 0.02F) * life * 0.5F, 0.2F * life * 0.5F, 0, 140.0F, 8.0F, 62.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 2, 0.0F, 0.0F, 0.4F, 0.45F, 0.015F, false, -1, false, (Entity)entityZamasu_Fused2);
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/*     */ 
/*     */         
/* 148 */         EntityCusPar entityCusPar2 = new EntityCusPar("jinryuumodscore:bens_particles.png", this.field_70170_p, 0.2F, 0.2F, ((Entity)entityZamasu_Fused2).field_70165_t, ((Entity)entityZamasu_Fused2).field_70163_u, ((Entity)entityZamasu_Fused2).field_70161_v, x, y, z, 0.0D, Math.random() * 0.05000000074505806D, 0.0D, 0.0F, (int)(Math.random() * 3.0D) + 8, 8, 3, 32, false, 0.0F, false, 0.0F, 1, "", 50, 2, ((float)(Math.random() * 0.029999999329447746D) + 0.03F) * life * 0.5F, ((float)(Math.random() * 0.009999999776482582D) + 0.02F) * life * 0.5F, 0.2F * life * 0.5F, 0, 184.0F, 147.0F, 241.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 2, 0.0F, 0.0F, 0.4F, 0.45F, 0.015F, false, -1, false, (Entity)entityZamasu_Fused2);
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/*     */ 
/*     */         
/* 184 */         EntityCusPar entityCusPar1 = new EntityCusPar("jinryuumodscore:bens_particles.png", this.field_70170_p, 0.2F, 0.2F, ((Entity)entityZamasu_Fused2).field_70165_t, ((Entity)entityZamasu_Fused2).field_70163_u, ((Entity)entityZamasu_Fused2).field_70161_v, x, y, z, 0.0D, Math.random() * 0.05000000074505806D, 0.0D, 0.0F, (int)(Math.random() * 3.0D) + 8, 8, 3, 32, false, 0.0F, false, 0.0F, 1, "", 50, 2, ((float)(Math.random() * 0.029999999329447746D) + 0.03F) * life * 0.5F, ((float)(Math.random() * 0.009999999776482582D) + 0.02F) * life * 0.5F, 0.2F * life * 0.5F, 0, 93.0F, 3.0F, 177.0F, 0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 2, 0.0F, 0.0F, 0.4F, 0.45F, 0.015F, false, -1, false, (Entity)entityZamasu_Fused2);
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/* Location:              D:\Projetos\Dragon-Block-Reborn\src\main\resources\references\DragonBlockC-v1.4.85.jar!\JinRyuu\DragonBC\common\Npcs\EntityZamasu_Fused2.class
