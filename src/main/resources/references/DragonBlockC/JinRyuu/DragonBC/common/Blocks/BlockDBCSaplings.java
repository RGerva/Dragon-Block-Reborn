...
public class BlockDBCSaplings extends BlockSapling {
   ...
   public IIcon func_149691_a(int p_149691_1_, int p_149691_2_) {
      p_149691_2_ &= 7;
      return p_149691_2_ != 0 ? field_149881_b[0] : field_149881_b[MathHelper.func_76125_a(p_149691_2_, 0, 5)];
   }
   ...
   public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_) {
      if (TerrainGen.saplingGrowTree(p_149878_1_, p_149878_5_, p_149878_2_, p_149878_3_, p_149878_4_)) {
         ...
         Object object = p_149878_5_.nextInt(10) == 0 ? new WorldGenNamekTrees(true) : new WorldGenNamekTrees(true);
         int i1 = 0;
         int j1 = 0;
         boolean flag = false;
         switch(l) {
         ...
         case 1:
            ...
            if (!((WorldGenerator)object).func_76484_a(p_149878_1_, p_149878_5_, p_149878_2_ + i1, p_149878_3_, p_149878_4_ + j1)) {
               if (flag) {
   ...
   public void func_149651_a(IIconRegister par1IconRegister) {
      for(int i = 0; i < field_149881_b.length; ++i) {
         field_149881_b[i] = par1IconRegister.func_94245_a("jinryuudragonbc:tile.Block" + field_149882_a[i] + "Sapling");
      }
