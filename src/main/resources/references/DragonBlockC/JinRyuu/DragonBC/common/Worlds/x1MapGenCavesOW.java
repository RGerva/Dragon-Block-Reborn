...
public class x1MapGenCavesOW extends MapGenBase {
   ...
   protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_) {
      ...
      for(boolean flag = random.nextInt(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_) {
         double d6 = 1.5D + (double)(MathHelper.func_76126_a((float)p_151541_15_ * 3.1415927F / (float)p_151541_16_) * p_151541_12_ * 1.0F);
         ...
         if (!flag2 && p_151541_15_ == k1 && p_151541_12_ > 1.0F && p_151541_16_ > 0) {
            this.func_151541_a(random.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, random.nextFloat() * 0.5F + 0.5F, p_151541_13_ - 1.5707964F, p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
            this.func_151541_a(random.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, random.nextFloat() * 0.5F + 0.5F, p_151541_13_ + 1.5707964F, p_151541_14_ / 3.0F, p_151541_15_, p_151541_16_, 1.0D);
            return;
         }
   ...
   protected void digBlock(Block[] data, int index, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
      BiomeGenBase biome = this.field_75039_c.func_72807_a(x + chunkX * 16, z + chunkZ * 16);
      Block top = this.isExceptionBiome(biome) ? Blocks.field_150349_c : biome.field_76752_A;
      Block filler = this.isExceptionBiome(biome) ? Blocks.field_150346_d : biome.field_76753_B;
      Block block = data[index];
      if (block == Blocks.field_150348_b || block == Blocks.field_150346_d || block == filler || block == top) {
         if (y < 10) {
            data[index] = Blocks.field_150353_l;
         } else {
            data[index] = null;
            if (foundTop && data[index - 1] == filler) {
               data[index - 1] = (Block)top;
            }
         }
      }
