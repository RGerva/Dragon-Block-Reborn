...
/*    */ 
/*    */ public class EntityRedRibbonSoldierB2 extends EntityRedRibbon2 {
/*  9 */   public final int AttPow = 20;
/* 10 */   public final int HePo = 80;
/*    */   
/*    */   public EntityRedRibbonSoldierB2(World world) {
/* 13 */     super(world);
/* 14 */     func_70105_a(0.6F, 2.0F);
/* 15 */     this.texture = "redribbon_soldierb2";
/* 16 */     setAttributes(DBCConfig.RRSoldier2DAM, DBCConfig.RRSoldier2HP, 20, 80);
/*    */   }
/*    */   
/*    */   protected void func_110147_ax() {
/* 20 */     super.func_110147_ax();
/* 21 */     func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(80.0D);
/* 22 */     func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(20.0D);
/*    */   }
/*    */   
...
/*    */     {
/* 30 */       if (this.field_70173_aa % 50 < 12 && this.field_70173_aa % 4 == 0) {
/*    */         
/* 32 */         EntityPrjtls_1 var8 = new EntityPrjtls_1(this.field_70170_p, (Entity)this, this.field_70789_a, 1.8F, 1.0F, 4);
...
/* Location:              D:\Projetos\Dragon-Block-Reborn\src\main\resources\references\DragonBlockC-v1.4.85.jar!\JinRyuu\DragonBC\common\Npcs\dbredribbon\EntityRedRibbonSoldierB2.class
