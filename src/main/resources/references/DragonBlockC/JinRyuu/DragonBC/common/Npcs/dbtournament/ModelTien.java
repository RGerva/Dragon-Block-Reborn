...
public class ModelTien extends ModelBase {
   ...
   public ModelTien() {
      ...
      this.Cloth = new ModelRenderer(this, 24, 0);
      this.Cloth.func_78793_a(2.5F, 9.8F, -2.0F);
      this.Cloth.func_78790_a(-1.5F, 0.0F, 0.0F, 3, 8, 0, 0.0F);
      this.setRotateAngle(this.Cloth, -0.045378562F, 0.0F, 0.0F);
      this.Head2 = new ModelRenderer(this, 0, 1);
      this.Head2.func_78793_a(0.0F, -7.8F, 0.4F);
      this.Head2.func_78790_a(-1.0F, -1.8F, -1.1F, 2, 2, 2, 0.0F);
      this.Eye = new ModelRenderer(this, 0, 0);
      this.Eye.func_78793_a(0.0F, -5.5F, -4.1F);
