...
public class ModelBuuFat extends ModelBiped {
   ...
   public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      if (this.field_78095_p > -9990.0F) {
         ...
         rota = MathHelper.func_76126_a(this.field_78095_p * 3.1415927F) * -(this.head.field_78795_f - 0.7F) * 0.75F;
         this.rightarm.field_78795_f = (float)((double)this.rightarm.field_78795_f - ((double)var9 * 1.2D + (double)rota));
         var10000 = this.rightarm;
