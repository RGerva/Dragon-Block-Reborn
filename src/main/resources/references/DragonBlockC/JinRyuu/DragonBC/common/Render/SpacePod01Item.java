...
public class SpacePod01Item extends Item {
   private Block spawnID;

   public SpacePod01Item(Block par2Block, ArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
      this.spawnID = BlocksDBC.SpacePod01Block;
