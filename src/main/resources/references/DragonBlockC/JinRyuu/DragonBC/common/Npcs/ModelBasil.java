...
public class ModelBasil extends ModelBase {
   ...
   public ModelBasil() {
      ...
      this.Back = new ModelRenderer(this, 44, 48);
      ...
      this.Scarf = new ModelRenderer(this, 17, 53);
      ...
      this.Fur = new ModelRenderer(this, 42, 14);
   ...
   public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      this.Back.field_78795_f = -0.15F - MathHelper.func_76134_b(par1 * 0.6662F) * 1.2F * par2;
