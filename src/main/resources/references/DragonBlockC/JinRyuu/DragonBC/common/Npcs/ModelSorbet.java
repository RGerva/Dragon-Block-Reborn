...
public class ModelSorbet extends ModelBase {
   ...
   public ModelSorbet() {
      ...
      this.ShoulderL = new ModelRenderer(this, 26, 9);
      ...
      this.ArmR = new ModelRenderer(this, 42, 30);
      ...
      this.Chest = new ModelRenderer(this, 6, 26);
      this.Chest.func_78793_a(0.0F, 0.0F, 0.0F);
      this.Chest.func_78790_a(-3.5F, 1.3F, -3.1F, 7, 2, 1, 0.0F);
      this.Cape = new ModelRenderer(this, 32, 19);
      ...
      this.ArmL = new ModelRenderer(this, 42, 30);
