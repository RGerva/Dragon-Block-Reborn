...
public class ModelAndroid8 extends ModelBase {
   ...
   public ModelAndroid8() {
      ...
      this.LegL = new ModelRenderer(this, 50, 36);
      this.LegL.field_78809_i = true;
      this.LegL.func_78793_a(3.3F, 10.0F, 1.5F);
      ...
      this.LegR = new ModelRenderer(this, 50, 36);
      this.LegR.func_78793_a(-3.3F, 10.0F, 1.5F);
      this.LegR.func_78790_a(-3.0F, 0.0F, -3.0F, 6, 14, 6, 0.1F);
      this.ArmR1 = new ModelRenderer(this, 52, 12);
      this.ArmR1.func_78793_a(-8.5F, -3.0F, 1.7F);
      this.ArmR1.func_78790_a(-3.5F, -2.0F, -3.0F, 5, 15, 6, 0.0F);
      this.ArmL1 = new ModelRenderer(this, 52, 12);
      this.ArmL1.field_78809_i = true;
      this.ArmL1.func_78793_a(8.5F, -3.0F, 1.7F);
      ...
      this.Body1.func_78790_a(-7.0F, 0.0F, -2.4F, 14, 8, 8, 0.0F);
