...
public class ModelCommanderRed extends ModelBase {
   ...
   public ModelCommanderRed() {
      ...
      this.Hair1 = new ModelRenderer(this, 0, 34);
      this.Hair1.func_78793_a(0.0F, -5.1F, 3.1F);
      this.Hair1.func_78790_a(-4.5F, -3.0F, -3.0F, 9, 4, 4, 0.0F);
      this.ArmL = new ModelRenderer(this, 44, 17);
      this.ArmL.field_78809_i = true;
      this.ArmL.func_78793_a(5.0F, 8.0F, 0.0F);
      this.ArmL.func_78790_a(-1.0F, -2.0F, -2.0F, 4, 9, 4, 0.0F);
      this.LegR = new ModelRenderer(this, 0, 18);
      this.LegR.func_78793_a(-2.0F, 15.0F, 0.0F);
      this.LegR.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F);
      this.LegL = new ModelRenderer(this, 0, 18);
      this.LegL.field_78809_i = true;
      this.LegL.func_78793_a(2.0F, 15.0F, 0.0F);
      this.LegL.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F);
      this.Hair2 = new ModelRenderer(this, 0, 43);
      this.Hair2.func_78793_a(0.0F, -5.7F, 0.0F);
      this.Hair2.func_78790_a(-2.5F, -2.8F, -4.4F, 5, 3, 6, 0.0F);
      this.Body = new ModelRenderer(this, 17, 17);
      this.Body.func_78793_a(0.0F, 6.0F, 0.0F);
      this.Body.func_78790_a(-4.0F, 0.0F, -2.5F, 8, 9, 5, 0.0F);
      this.ArmR = new ModelRenderer(this, 44, 3);
      this.ArmR.func_78793_a(-5.0F, 8.0F, 0.0F);
      this.ArmR.func_78790_a(-3.0F, -2.0F, -2.0F, 4, 9, 4, 0.0F);
