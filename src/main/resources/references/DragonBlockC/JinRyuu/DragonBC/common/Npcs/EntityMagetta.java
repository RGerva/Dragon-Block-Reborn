...
public class EntityMagetta extends EntityDBCEvil {
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(76000.0D);
