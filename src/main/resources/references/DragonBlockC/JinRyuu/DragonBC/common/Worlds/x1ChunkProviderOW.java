...
public class x1ChunkProviderOW implements IChunkProvider {
   private Random rand;
   ...
   public void genBiomeModdedTerrain(BiomeGenBaseDBC bgb, World world, Random random, Block[] replacableBlock, byte[] aByte, int x, int y, double z) {
      ...
      for(int l1 = 255; l1 >= 0; --l1) {
            ...
            if (block2 != null && block2.func_149688_o() != Material.field_151579_a) {
               if (block2 == Blocks.field_150348_b) {
                  if (k == -1) {
                     ...
                     if (l1 < 40 && (block == null || block.func_149688_o() == Material.field_151579_a)) {
                  ...
                  if (height == 0) {
                     ...
                     if (o85 && l1 >= 80 && 80 + (height - 80) / 10 == l1) {
                        replacableBlock[i2] = BlocksDBC.BlockYellowCloud;
                     } else if (height - hch + 1 >= l1 && height - hch + 1 <= l1) {
                        replacableBlock[i2] = bgb.field_76753_B;
                     } else {
                        replacableBlock[i2] = Blocks.field_150350_a;
                     }
                  }
         ...
         block2 = replacableBlock[i2];
         if (l1 < 200 && block2 == Blocks.field_150355_j) {
            replacableBlock[i2] = Blocks.field_150350_a;
         }
      }
   ...
   public List func_73155_a(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4) {
      ...
      return (List)(par1EnumCreatureType == EnumCreatureType.monster && this.scatteredFeatureGenerator.func_143030_a(par2, par3, par4) ? this.scatteredFeatureGenerator.func_82667_a() : (r == 0 ? biomegenbase.func_76747_a(par1EnumCreatureType) : new ArrayList()));
   }
