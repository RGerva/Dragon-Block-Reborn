...
public class EntityCymbal extends EntityDBCEvil {
   public String tex;
   ...
   public EntityCymbal(World par1World) {
      ...
      this.tex = "cymbal";
      this.func_70105_a(0.90000004F, 3.0F);
      this.setData2(2);
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(80.0D);
   }
