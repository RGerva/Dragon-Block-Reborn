...
public class AAiDBCGroundJump extends AAi {
   ...
   public void update() {
      ...
      if (entity.func_70089_S() && !entity.world.field_72995_K && !entity.isLocked() && entity.getTargetedEntity() != null && entity.getTargetedEntity().func_70089_S() && entity.getTargetedEntity().func_70068_e(entity) < 4096.0D) {
         ...
         if (!JGMathHelper.doubleSmallerThan(xzDist - this.xzDistLast, 0.01D) && (!JGMathHelper.doubleSmallerThan(entity.posX - this.posXLast, 0.01D) || !JGMathHelper.doubleSmallerThan(entity.posZ - this.posZLast, 0.01D))) {
            this.stillStandingCountdown = 10;
         } else {
         ...
         if ((!entity.canFly || entity.getTargetedEntity().field_70122_E || attemptRandomJump || this.isStandingStill()) && (attemptRandomJump || this.isStandingStill() || yDist > (double)(entity.field_70131_O * 1.5F)) && (attemptRandomJump || this.isStandingStill() || entity.getTargetedEntity().posY - entity.posY > 0.0D) && entity.field_70122_E && !entity.isJumping() && this.checkChanceToUse(this.rate)) {
            ...
            double xDiff = (entity.getTargetedEntity().posX - entity.posX) / 10.0D * this.multi2;
            double zDiff = (entity.getTargetedEntity().posZ - entity.posZ) / 10.0D * this.multi2;
