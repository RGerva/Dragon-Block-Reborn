...
public class EntityMaiMecha extends EntityDBCEvil {
   public String tex;
   ...
   public EntityMaiMecha(World par1World) {
      ...
      this.tex = "mai_mecha";
      this.func_70105_a(1.8000001F, 4.5F);
      this.setData2(2);
      this.canFly = false;
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(110.0D);
