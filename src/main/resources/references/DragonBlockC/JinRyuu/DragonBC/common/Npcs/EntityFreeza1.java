...
public class EntityFreeza1 extends EntityDBCEvil {
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(200.0D);
   }
   ...
   public void func_70645_a(DamageSource par1DamageSource) {
      ...
      if (var3 instanceof EntityPlayer) {
         ((EntityPlayer)var3).func_145747_a((new ChatComponentTranslation(JRMCoreH.trlai("dbc.itemFreeSagaFre.d.1.line1"), new Object[0])).func_150255_a(JRMCoreH2.styl_wht));
   ...
   public boolean func_70097_a(DamageSource par1DamageSource, float par2) {
      if (this.func_85032_ar()) {
         ...
         if (var3 instanceof EntityPlayer) {
            ...
            for(int var5 = 0; var5 < var4.size(); ++var5) {
               Entity var6 = (Entity)var4.get(var5);
               if (var6 instanceof EntityFreeza1) {
