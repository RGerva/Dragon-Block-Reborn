...
public class EntityVegetaCopyBlue extends EntityDBCEvil {
      ...
      if (this.field_70170_p.field_72995_K && JGConfigClientSettings.CLIENT_DA8) {
         ...
         for(int k = 0; k < JGConfigClientSettings.get_da1(); ++k) {
            ...
            for(i = 0; i < 2; ++i) {
               ...
               entity2 = new EntityCusPar("jinryuudragonbc:bens_particles.png", this.field_70170_p, 0.2F, 0.2F, super.field_70165_t, super.field_70163_u, super.field_70161_v, x, y, z, 0.0D, 0.05D + Math.random() * 0.10000000149011612D, 0.0D, 0.0F, (int)(Math.random() * 8.0D) + 48, 48, 8, 32, false, 0.0F, false, 0.0F, 1, "", 25, 0, 0.003F + (float)(Math.random() * 0.006000000052154064D), 0.0F, 0.0F, 0, 160.0F, 220.0F, 255.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 2, 0.8F, 0.0F, 0.9F, 0.95F, 0.02F, false, -1, false, this);
