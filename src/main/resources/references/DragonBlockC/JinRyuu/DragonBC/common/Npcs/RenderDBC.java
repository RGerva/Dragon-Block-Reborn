...
public class RenderDBC extends RendererLivingEntity {
   ...
   protected ResourceLocation getEntityTexture(Entity entity) {
      if (entity instanceof EntityNamekian03) {
         ...
         return entity instanceof EntityNamekFrog ? new ResourceLocation(((EntityNamekFrog)entity).getTexture()) : new ResourceLocation("jinryuudragonbc:npcs/" + entity.getName().replaceAll("entity.jinryuudragonblockc.", "").replaceAll(".name", "") + ".png");
      }
   }
   ...
   protected void func_77033_b(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6) {
      if (!MinecraftForge.EVENT_BUS.post(new Pre(par1EntityLivingBase, this, par2, par4, par6))) {
         if (this.b) {
            ...
            double d3 = par1EntityLivingBase.func_70068_e(this.renderManager.field_78734_h);
            float f2 = par1EntityLivingBase.func_70093_af() ? NAME_TAG_RANGE_SNEAK : NAME_TAG_RANGE;
            if (d3 < (double)(f2 * f2)) {
               String s = par1EntityLivingBase.getName();
