...
public class ModelDino01 extends ModelBase {
   ...
   public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      var10000 = this.Tail5;
      var10000.field_78796_g += r4;
      this.LegR1.field_78795_f = -0.8F - MathHelper.func_76134_b(par1 * 0.6662F) * 1.2F * par2;
      this.LegL1.field_78795_f = -0.8F - MathHelper.func_76134_b(par1 * 0.6662F + 3.1415927F) * 1.2F * par2;
      this.ArmR1.field_78795_f = -0.4F + MathHelper.func_76134_b(par1 * 0.6662F) * 1.2F * par2;
      this.ArmL1.field_78795_f = -0.4F + MathHelper.func_76134_b(par1 * 0.6662F + 3.1415927F) * 1.2F * par2;
