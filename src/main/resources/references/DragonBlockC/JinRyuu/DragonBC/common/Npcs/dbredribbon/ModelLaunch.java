...
public class ModelLaunch extends ModelBase {
   ...
   public ModelLaunch() {
      ...
      this.Hair6 = new ModelRenderer(this, 49, 7);
      ...
      this.HairBack2 = new ModelRenderer(this, 47, 33);
      ...
      this.HairFront = new ModelRenderer(this, 41, 15);
      ...
      this.Ribbon = new ModelRenderer(this, 24, 18);
      ...
      this.Hair7 = new ModelRenderer(this, 49, 0);
      ...
      this.HairBack1 = new ModelRenderer(this, 39, 26);
