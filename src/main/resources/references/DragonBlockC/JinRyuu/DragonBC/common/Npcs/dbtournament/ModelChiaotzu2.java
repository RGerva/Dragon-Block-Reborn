...
public class ModelChiaotzu2 extends ModelBase {
   ...
   public ModelChiaotzu2() {
      ...
      this.Head_1.func_78793_a(0.0F, -7.8F, 0.4F);
   ...
   public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      this.Cape.field_78795_f = -0.15F - MathHelper.func_76134_b(par1 * 0.6662F) * 1.2F * par2;
