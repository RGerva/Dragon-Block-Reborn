...
public class BlockAnyBase extends Block {
   private Random rand;
   ...
   public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
      if (this.func_149650_a(p_149690_5_, this.rand, p_149690_7_) != Item.func_150898_a(this)) {
         int j1 = 0;
         if (this == BlocksDBC.BlockOreJJay) {
            j1 = MathHelper.func_76136_a(this.rand, 0, 2);
         } else if (this == BlocksDBC.BlockOreDnomaid) {
            j1 = MathHelper.func_76136_a(this.rand, 3, 7);
         }
