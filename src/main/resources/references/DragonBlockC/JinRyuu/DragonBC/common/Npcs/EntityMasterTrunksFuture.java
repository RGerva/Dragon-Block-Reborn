...
public class EntityMasterTrunksFuture extends EntityDBCKami {
   ...
   public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
      ...
      if (this.func_70089_S()) {
         par1EntityPlayer.openGui(mod_DragonBC.instance, 23, par1EntityPlayer.field_70170_p, (int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v);
         return true;
      } else {
