...
public class ModelOfficerBlack extends ModelBase {
   ...
   public ModelOfficerBlack() {
      ...
      this.RedRibbon = new ModelRenderer(this, 24, 0);
      this.RedRibbon.func_78793_a(2.4F, 3.9F, -2.2F);
      this.RedRibbon.func_78790_a(-1.5F, 0.0F, 0.0F, 3, 3, 0, 0.0F);
      this.setRotateAngle(this.RedRibbon, -0.061086524F, 0.0F, 0.0F);
      this.Body2 = new ModelRenderer(this, 25, 17);
      this.Body2.func_78793_a(0.0F, 0.0F, 0.0F);
      this.Body2.func_78790_a(-4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F);
      this.LegL = new ModelRenderer(this, 0, 35);
      this.LegL.field_78809_i = true;
      this.LegL.func_78793_a(2.0F, 12.0F, 0.0F);
      this.LegL.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F);
      this.ArmR2 = new ModelRenderer(this, 17, 35);
      ...
      this.ArmL = new ModelRenderer(this, 34, 35);
      this.ArmL.field_78809_i = true;
      this.ArmL.func_78793_a(5.0F, 2.0F, 0.0F);
      this.ArmL.func_78790_a(-1.0F, -2.0F, -2.0F, 4, 9, 4, 0.1F);
      this.Head = new ModelRenderer(this, 0, 0);
      this.Head.func_78793_a(0.0F, 0.0F, 0.0F);
      this.Head.func_78790_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
      this.ArmL2 = new ModelRenderer(this, 17, 35);
      this.ArmL2.field_78809_i = true;
      this.ArmL2.func_78793_a(0.0F, 0.0F, 0.0F);
      this.ArmL2.func_78790_a(-1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F);
      this.ArmR = new ModelRenderer(this, 34, 35);
      this.ArmR.func_78793_a(-5.0F, 2.0F, 0.0F);
      this.ArmR.func_78790_a(-3.0F, -2.0F, -2.0F, 4, 9, 4, 0.1F);
      this.Cloth1 = new ModelRenderer(this, 1, 52);
      this.Cloth1.func_78793_a(0.0F, 10.3F, 0.6F);
      this.Cloth1.func_78790_a(-4.5F, 0.0F, -2.2F, 9, 7, 4, 0.0F);
      ...
      this.Body.func_78792_a(this.RedRibbon);
      this.Body.func_78792_a(this.Body2);
      this.ArmR.func_78792_a(this.ArmR2);
      this.Body2.func_78792_a(this.Tie);
   ...
   public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      this.Cloth1.field_78795_f = 0.15F + this.LegR.field_78795_f * (float)(this.LegR.field_78795_f >= 0.0F ? -1 : 1) * 1.0F;
      this.Cloth1.field_78795_f = 0.15F + this.LegL.field_78795_f * (float)(this.LegR.field_78795_f >= 0.0F ? -1 : 1) * 1.0F;
      this.Cloth1.field_78795_f = 0.15F + this.LegL.field_78795_f * (float)(this.LegR.field_78795_f >= 0.0F ? -1 : 1) * 1.0F;
