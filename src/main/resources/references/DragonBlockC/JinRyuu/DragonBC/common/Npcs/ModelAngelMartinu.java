...
public class ModelAngelMartinu extends ModelBase {
   ...
   public ModelAngelMartinu() {
      ...
      this.Hair2 = new ModelRenderer(this, 52, 0);
      ...
      this.ClothB = new ModelRenderer(this, 52, 51);
      ...
      this.ClothF = new ModelRenderer(this, 36, 51);
      ...
      this.Boobs = new ModelRenderer(this, 4, 16);
