...
public class ModelLemo extends ModelBase {
   ...
   public ModelLemo() {
      ...
      this.ArmR = new ModelRenderer(this, 26, 21);
      this.ArmR.func_78793_a(-4.6F, 2.7F, 0.0F);
      this.ArmR.func_78790_a(-1.7F, -1.4F, -1.8F, 3, 11, 4, -0.1F);
      this.setRotateAngle(this.ArmR, 0.0F, 0.0F, 0.034906585F);
      this.ArmL = new ModelRenderer(this, 26, 21);
      this.ArmL.field_78809_i = true;
      this.ArmL.func_78793_a(4.6F, 2.7F, 0.0F);
      this.ArmL.func_78790_a(-1.3F, -1.4F, -1.8F, 3, 11, 4, -0.1F);
      this.setRotateAngle(this.ArmL, 0.0F, 0.0F, -0.034906585F);
      this.Scouter = new ModelRenderer(this, 25, 0);
