...
public class x3ChunkProviderVegeta implements IChunkProvider {
   private Random rand;
   ...
   public void func_73153_a(IChunkProvider par1IChunkProvider, int par2, int par3) {
      ...
      int l1;
      int i2;
      if (biomegenbase != BiomeGenBase.field_76769_d && biomegenbase != BiomeGenBase.field_76786_s && !flag && this.rand.nextInt(4) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, EventType.LAKE)) {
      ...
      if (TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, EventType.LAVA) && !flag && this.rand.nextInt(8) == 0) {
         k1 = k + this.rand.nextInt(16) + 8;
      ...
      boolean doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, EventType.DUNGEON);
      ...
      if (TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, EventType.ANIMALS)) {
         SpawnerAnimals.func_77191_a(this.worldObj, biomegenbase, k + 8, l + 8, 16, 16, this.rand);
      }

      k += 8;
      l += 8;
      doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, EventType.ICE);
