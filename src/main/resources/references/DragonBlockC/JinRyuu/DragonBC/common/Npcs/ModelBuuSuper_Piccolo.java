...
public class ModelBuuSuper_Piccolo extends ModelBase {
   ...
   public ModelBuuSuper_Piccolo() {
      ...
      this.CapeNeck = new ModelRenderer(this, 71, 4);
      ...
      this.CapeR = new ModelRenderer(this, 50, 18);
   ...
   public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      this.CapeBack.field_78795_f = -0.15F - MathHelper.func_76134_b(par1 * 0.6662F) * 1.2F * par2;
      if (0.0F > this.CapeBack.field_78795_f) {
         ModelRenderer var10000 = this.CapeBack;
