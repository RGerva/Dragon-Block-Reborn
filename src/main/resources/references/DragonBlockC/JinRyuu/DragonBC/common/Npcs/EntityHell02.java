...
/*  80 */     return "jinryuudragonbc:npcs/hell02.png";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 115 */     return (this.angerLevel == 0) ? null : super.func_70782_k();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 163 */     if (func_85032_ar())
/*     */     {
/* 165 */       return false;
/*     */     }
/*     */ 
/*     */     
/* 169 */     Entity var3 = par1DamageSource.func_76346_g();
/*     */     
/* 171 */     if (var3 instanceof EntityPlayer) {
/*     */       
/* 173 */       List<Entity> var4 = this.field_70170_p.func_72839_b((Entity)this, this.field_70121_D.func_72314_b(32.0D, 32.0D, 32.0D));
/*     */       
/* 175 */       for (int var5 = 0; var5 < var4.size(); var5++) {
/*     */         
/* 177 */         Entity var6 = var4.get(var5);
/*     */         
/* 179 */         if (var6 instanceof EntityHell02) {
/*     */           
/* 181 */           EntityHell02 var7 = (EntityHell02)var6;
/* 182 */           var7.becomeAngryAt(var3);
/*     */         } 
/*     */       } 
/*     */       
/* 186 */       becomeAngryAt(var3);
/*     */     } 
/*     */     
/* 189 */     return super.func_70097_a(par1DamageSource, par2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 198 */     this.field_70789_a = par1Entity;
/* 199 */     this.angerLevel = 400 + this.field_70146_Z.nextInt(400);
/* 200 */     this.randomSoundDelay = this.field_70146_Z.nextInt(40);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Projetos\Dragon-Block-Reborn\src\main\resources\references\DragonBlockC-v1.4.85.jar!\JinRyuu\DragonBC\common\Npcs\EntityHell02.class
