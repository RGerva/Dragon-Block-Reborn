...
public class EntityBuyon extends EntityDBCEvil {
   public String tex;
   ...
   protected void func_110147_ax() {
      ...
      this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(90.0D);
   }
