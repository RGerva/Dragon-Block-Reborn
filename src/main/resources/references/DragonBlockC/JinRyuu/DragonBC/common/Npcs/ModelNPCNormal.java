...
public class ModelNPCNormal extends ModelBiped {
   ...
   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      this.field_78116_c.rotateAngleY = par4 / 57.295776F;
      this.field_78116_c.rotateAngleX = par5 / 57.295776F;
      this.field_78114_d.rotateAngleY = this.field_78116_c.rotateAngleY;
      ...
      this.field_78123_h.rotateAngleY = 0.0F;
      this.field_78124_i.rotateAngleY = 0.0F;
      ...
      if (this.field_78093_q) {
         ...
         this.field_78123_h.rotateAngleY = 0.31415927F;
         this.field_78124_i.rotateAngleY = -0.31415927F;
      }
      ...
      this.field_78112_f.rotateAngleY = 0.0F;
      this.field_78113_g.rotateAngleY = 0.0F;
      float var8;
      float var9;
      if (this.field_78095_p > -9990.0F) {
         var8 = this.field_78095_p;
         this.field_78115_e.rotateAngleY = MathHelper.func_76126_a(MathHelper.func_76129_c(var8) * 3.1415927F * 2.0F) * 0.2F;
         this.field_78112_f.field_78798_e = MathHelper.func_76126_a(this.field_78115_e.rotateAngleY) * 5.0F;
         this.field_78112_f.field_78800_c = -MathHelper.func_76134_b(this.field_78115_e.rotateAngleY) * 5.0F;
         this.field_78113_g.field_78798_e = -MathHelper.func_76126_a(this.field_78115_e.rotateAngleY) * 5.0F;
         this.field_78113_g.field_78800_c = MathHelper.func_76134_b(this.field_78115_e.rotateAngleY) * 5.0F;
         var10000 = this.field_78112_f;
         var10000.rotateAngleY += this.field_78115_e.rotateAngleY;
         var10000 = this.field_78113_g;
         var10000.rotateAngleY += this.field_78115_e.rotateAngleY;
         var10000 = this.field_78113_g;
         var10000.rotateAngleX += this.field_78115_e.rotateAngleY;
         ...
         var10000 = this.field_78112_f;
         var10000.rotateAngleY += this.field_78115_e.rotateAngleY * 2.0F;
      ...
      if (this.field_78118_o) {
         ...
         this.field_78112_f.rotateAngleZ = 0.0F;
         this.field_78113_g.rotateAngleZ = 0.0F;
         this.field_78112_f.rotateAngleY = -(0.1F - var8 * 0.6F) + this.field_78116_c.rotateAngleY;
         this.field_78113_g.rotateAngleY = 0.1F - var8 * 0.6F + this.field_78116_c.rotateAngleY + 0.4F;
   ...
   public void func_78110_b(float par1) {
      this.field_78121_j.rotateAngleY = this.field_78116_c.rotateAngleY;
