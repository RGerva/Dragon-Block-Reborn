...
public class ItemDragonRadar extends Item {
   ...
   public void func_77624_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
      par3List.add(StatCollector.func_74838_a("dbc.itemDRadar.line1"));
      par3List.add(StatCollector.func_74838_a("dbc.itemDRadar.line2"));
      par3List.add(StatCollector.func_74838_a("dbc.itemDRadar.line3"));
   }
