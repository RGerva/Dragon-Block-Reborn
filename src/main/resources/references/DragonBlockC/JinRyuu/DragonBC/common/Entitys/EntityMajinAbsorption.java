...
public class EntityMajinAbsorption extends Entity implements IThrowableEntity, IEntityAdditionalSpawnData, IEntitySelector, IProjectile {
   ...
   public EntityMajinAbsorption(EntityLivingBase userEntity, int skillLevel, int bodyColor, float userPower, float userAttack, int stateID) {
      ...
      double x = userEntity.field_70165_t + vec3.field_72450_a * d8;
      double y = userEntity.field_70163_u + vec3.field_72448_b * d8 + (double)(userEntity.field_70131_O * 0.55F);
      double z = userEntity.field_70161_v + vec3.field_72449_c * d8;
   ...
   public void func_70071_h_() {
      ...
      super.func_70071_h_();
      if (this.field_70170_p.field_72995_K || this.field_70173_aa < JGConfigRaces.CONFIG_MAJIN_ABSORPTON_MAX_TICK_LIFE[this.stateID][0] && (this.prevX != this.field_70165_t || this.prevY != this.field_70163_u || this.prevZ != this.field_70161_v)) {
         this.prevCount = 0;
      } else {
         ++this.prevCount;
      ...
      if (this.inGround) {
         ...
         if (block == this.inTile && var19 == this.inData) {
            ...
            if (this.ticksInGround == (t == 0 ? 10 : t)) {
               this.field_70170_p.func_72956_a(this, "jinryuudragonbc:DBC5.majin_bodypart", 0.4F, 1.0F);
            }
         ...
         if (!this.field_70170_p.field_72995_K && this.ticksInAir >= 2000 && this.target == null && this.getMode() != 2) {
            this.func_70106_y();
         }
         ...
         if (!this.field_70170_p.field_72995_K) {
            var5 = null;
            HITBOX = 2.0D;
            var6 = this.field_70170_p.func_72839_b(this, this.field_70121_D.func_72321_a(this.field_70159_w, this.field_70181_x, this.field_70179_y).func_72314_b(2.0D, 2.0D, 2.0D));
            distY = 0.0D;
            var9 = 0;
         ...
         if (!this.field_70170_p.field_72995_K && this.target == null) {
            var5 = null;
            HITBOX = 4.0D;
            var6 = this.field_70170_p.func_72839_b(this, this.field_70121_D.func_72321_a(this.field_70159_w, this.field_70181_x, this.field_70179_y).func_72314_b(4.0D, 4.0D, 4.0D));
            distY = 0.0D;
            ...
            for(var9 = 0; var9 < var6.size(); ++var9) {
               ...
               if (var10 instanceof EntityLivingBase && var10 != null && ((EntityLivingBase)var10).func_70089_S() && var10 != this.shootingEntity && var10.func_70067_L() && !this.isEntityOnTheBlacklist(var10) && !JRMCoreH.isFusionSpectator(var10) && !JRMCoreH.isInCreativeMode(var10)) {
                  if (this.target == null) {
                     ...
                     double distX = this.target.field_70165_t - this.field_70165_t;
                     if (distX < 0.0D) {
                        distX *= -1.0D;
                     }

                     distY = this.target.field_70163_u + (double)(this.target.field_70131_O / 2.0F) - this.field_70163_u;
                     if (distY < 0.0D) {
                        distY *= -1.0D;
                     }

                     double distZ = this.target.field_70161_v - this.field_70161_v;
                     if (distZ < 0.0D) {
                        distZ *= -1.0D;
                     }

                     double dist = distX + distY + distZ;
                     double distX2 = var10.field_70165_t - this.field_70165_t;
                     if (distX2 < 0.0D) {
                        distX2 *= -1.0D;
                     }

                     double distY2 = var10.field_70163_u - this.field_70163_u;
                     if (distY2 < 0.0D) {
                        distY2 *= -1.0D;
                     }

                     double distZ2 = var10.field_70161_v - this.field_70161_v;
                     if (distZ2 < 0.0D) {
                        distZ2 *= -1.0D;
                     }
         ...
         if (var4 != null && this.target == null && this.mode <= 0 && !this.field_70170_p.func_147439_a(var4.field_72311_b, var4.field_72312_c, var4.field_72309_d).func_149739_a().equals("tile.bedrock")) {
         ...
         if (target != null) {
            double distX = target.field_70165_t - this.field_70165_t;
            distY = target.field_70163_u + (double)(target.field_70131_O / 2.0F) - this.field_70163_u;
            double distZ = target.field_70161_v - this.field_70161_v;
            double div = 20.0D;
               ...
               if (this.shootingEntity != null && this.shootingEntity.func_70089_S()) {
                  if (JGMathHelper.doubleSmallerThan(distX, HIT_DISTANCE) && JGMathHelper.doubleSmallerThan(distY, HIT_DISTANCE) && JGMathHelper.doubleSmallerThan(distZ, HIT_DISTANCE)) {
                     ...
                     if (this.getMode() == 2) {
                        ...
                        this.field_70170_p.func_72956_a(this, "jinryuudragonbc:DBC5.majin_absorption2", 0.4F, 1.0F);
                        this.func_70106_y();
                              ...
                              while(true) {
                                 if (i >= 3) {
                                    ...
                                    if (this.target.func_70097_a(damagesource, targetHealthOG)) {
                                       this.field_70170_p.func_72956_a(this, "jinryuudragonbc:DBC5.majin_absorption", 0.3F, 1.0F);
                                    } else {
                                       this.func_70106_y();
                                    }
                                    break;
         ...
         for(this.targetH = this.func_70096_w().func_111145_d(22); this.field_70125_A - this.field_70127_C >= 180.0F; this.field_70127_C += 360.0F) {
         }
   ...
   public void readSpawnData(ByteBuf data) {
      ...
      this.target = second == 0 ? this.target : this.field_70170_p.func_73045_a(second);
