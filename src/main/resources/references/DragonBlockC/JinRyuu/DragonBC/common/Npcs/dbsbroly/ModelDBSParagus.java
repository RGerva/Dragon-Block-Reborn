...
public class ModelDBSParagus extends ModelBase {
   ...
   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
      ...
      float r = 360.0F;
      float r2 = 180.0F;
      this.Hair.rotateAngleY = par4 / (r2 / 3.1415927F);
      this.Hair.rotateAngleX = par5 / (r2 / 3.1415927F);
      ...
      this.ArmR.rotateAngleX = -0.0F + MathHelper.func_76134_b(par1 * 0.6662F) * 0.3F * par2;
