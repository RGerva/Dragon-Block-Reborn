...
public class EntityRRMecha extends EntityDBCWildlifeA implements IMob, IEntityAdditionalSpawnData {
   ...
   public void func_70071_h_() {
      ...
      if (!this.field_70170_p.field_72995_K && this.field_70789_a != null && this.field_70789_a.func_70089_S() && this.field_70789_a.func_70032_d(this) < range) {
         EntityPrjtls_1 var8;
         if (this.type == 0) {
            if (this.field_70173_aa % 100 < 31 && this.field_70173_aa % 15 == 0) {
               var8 = new EntityPrjtls_1(this.field_70170_p, this, this.field_70789_a, 1.8F, 1.0F, 0);
            ...
            if (this.field_70173_aa % 100 == 0 && (int)(Math.random() * (double)(6 / (this.type + 1))) == 0) {
               var8 = new EntityPrjtls_1(this.field_70170_p, this, this.field_70789_a, 1.5F, 1.0F, 1);
               this.field_70170_p.func_72956_a(this, "jinryuudragonbc:DBC4.rocket_shot", 0.6F, this.field_70170_p.field_73012_v.nextFloat() * 0.1F + 0.9F);
               this.field_70170_p.func_72838_d(var8);
            }
         } else if (this.type == 2 && this.field_70173_aa % 100 == 0 && (int)(Math.random() * 2.0D) == 0) {
