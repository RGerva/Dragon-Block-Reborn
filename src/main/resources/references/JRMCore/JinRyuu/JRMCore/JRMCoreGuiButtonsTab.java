...
public class JRMCoreGuiButtonsTab extends GuiButton {
   private int col;
   ...
   public void func_146112_a(Minecraft par1Minecraft, int par2, int par3) {
      if (this.field_146125_m) {
         ...
         int var5 = this.func_146114_a(this.field_146123_n) - this.col;
         this.func_73729_b(this.field_146128_h, this.field_146129_i, 0, 196 + var5 * 20, this.field_146120_f / 2, this.field_146121_g);
         this.func_73729_b(this.field_146128_h + this.field_146120_f / 2, this.field_146129_i, 200 - this.field_146120_f / 2, 196 + var5 * 20, this.field_146120_f / 2, this.field_146121_g);
