...
public class RenderCusPar extends RenderJRMC {
   ...
   public void renderAura(EntityCusPar entity, double parX, double parY, double parZ, float par8, float par9) {
      ...
      if (!harom) {
         ...
         if (entity.getdata42() == 0) {
            ...
            GL11.glRotatef(entity.getEnt().field_70177_z, 0.0F, 1.0F, 0.0F);
         } else if (entity.getdata42() == 2 && entity.hasEnt()) {
            GL11.glRotatef(entity.getEnt().field_70125_A * (float)(view2 ? 1 : -1), 1.0F, 0.0F, 0.0F);
         } else if (entity.getdata42() == 3 && entity.hasEnt()) {
            GL11.glRotatef(entity.getEnt().field_70177_z, 0.0F, 1.0F, 0.0F);
            if (!view2) {
               GL11.glRotatef(entity.getEnt().field_70125_A, -1.0F, 0.0F, 0.0F);
            } else {
               GL11.glRotatef(entity.getEnt().field_70125_A, -1.0F, 0.0F, 0.0F);
            }
         }
   ...
   private void fieldPass2(EntityCusPar e) {
      ...
      int id = e.getId();
      float rot = (float)(e.field_70173_aa * 5) * e.getRotation_Sp();
      GL11.glRotatef((e.getRotation() ? rot : 0.0F - rot) + e.getdata39(), 0.0F, 0.0F, 1.0F);
      float rot2 = (float)(e.field_70173_aa * 5) * e.getRotation_Sp2() * 2.0F;
      ...
      float f = e.getdata28();
      if (e.getdata35() && e.hasEnt() && JRMCoreClient.mc.field_71439_g != null && e.getEnt().equals(JRMCoreClient.mc.field_71439_g) && JRMCoreClient.mc.field_71474_y.field_74320_O == 0) {
         f *= (float)JGConfigClientSettings.CLIENT_DA3 / 10.0F;
      }

      float clr1 = this.func_rch(e, e.getdata8(), e.getdata11(), e.getdata14(), (float)e.field_70173_aa);
      float clr2 = this.func_rch(e, e.getdata9(), e.getdata12(), e.getdata15(), (float)e.field_70173_aa);
      float clr3 = this.func_rch(e, e.getdata10(), e.getdata13(), e.getdata16(), (float)e.field_70173_aa);
   ...
   private void fieldPass3(int guiLeftO, int guiTopO, EntityCusPar e) {
      ...
      if (type == 0) {
         this.model1.func_78088_a(e, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
      } else {
         this.model2.func_78088_a(e, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
      }
   ...
   private float func_rch(EntityCusPar entity, float f1, float f2, float f3, float f4) {
      ...
      if (entity.getdata31() == 1) {
         ...
         if (f1 < f3) {
            ...
            egy = szaz / 100.0F;
            calc = (float)entity.field_70173_aa / egy;
   ...
   private float func_cs(EntityCusPar entity) {
      ...
      if (entity.getdata4() == 0) {
         ...
         f2 = entity.getdata7();
         f3 = entity.getdata6();
         f1 = entity.getdata5() + (float)entity.field_70173_aa * f2;
         if (f2 > 0.0F && f1 > f3) {
            f1 = f3;
         ...
         float calc = (float)entity.field_70173_aa / egy;
         if (f2 > 0.0F) {
