...
public class EntityEnergyAttJ extends EntityEnAttacks implements IThrowableEntity, IEntityAdditionalSpawnData, IEntitySelector, IProjectile {
   ...
   public void func_70071_h_() {
      ...
      if (!this.field_70170_p.field_72995_K && this.isContinuesWave() && this.target != null && !this.target.field_70128_L && !this.shooterHolds && JGMathHelper.isMotionSmallerThanN(this, 0.001D)) {
         this.func_70106_y();
      }
      ...
      if (JRMCoreConfig.WavesShrinkOnceLetGo) {
         if (this.shootingEntity != null && this.shootingEntity instanceof EntityPlayer && this.isContinuesWave() && this.shooterHolds) {
            ...
            double z = this.shootingEntity.field_70161_v + vec3.field_72449_c * x;
            if (x < 0.0D) {
               x *= -1.0D;
            }
         ...
         var7 = this.shootingEntity.field_70163_u + (double)(this.field_70170_p.field_72995_K ? JGPlayerClientServerHelper.clientPlayerPositioner(this.shootingEntity) : 0.0F);
         if (var7 < 0.0D) {
            var7 *= -1.0D;
         }
      ...
      if (!this.field_70170_p.field_72995_K && this.isContinuesWave() && JRMCoreConfig.ContinuesEnergyAttackEnemyLock && this.target != null && !this.target.field_70128_L && this.shooterHolds) {
         ...
         var7 = this.target.field_70163_u;
         if (var7 < 0.0D) {
            var7 *= -1.0D;
         }
      ...
      if (!this.field_70170_p.field_72995_K && JRMCoreConfig.WavesDieWhenTargetAway && this.shootingEntity != null && this.target != null && this.shootingEntity instanceof EntityPlayer && this.isContinuesWave()) {
         ...
         if (kulx > (double)den || kuly > (double)den || kulz > (double)den) {
            if (this.type >= 0 && this.type < 2) {
               ...
               this.field_70170_p.func_72956_a(this, this.pwrtyp == 1 ? this.DBCExplSound : (this.pwrtyp == 2 ? this.NCExplSound : ""), 1.0F, 1.0F);
            }
      ...
      if (this.inGround) {
         ...
         if (!this.field_70170_p.field_72995_K) {
            Entity var5 = null;
            var5 = this.field_70170_p.func_72839_b(this, this.field_70121_D.func_72321_a(this.field_70159_w, this.field_70181_x, this.field_70179_y).func_72314_b(0.5D, 0.5D, 0.5D));
            var7 = 0.0D;
            var9 = 0;
         ...
         if (!this.field_70170_p.field_72995_K) {
            ...
            List var6 = this.field_70170_p.func_72839_b(this, aabb);
         ...
         for(var23 = 0; this.field_70125_A - this.field_70127_C >= 180.0F && var23 < 20; ++var23) {
            this.field_70127_C += 360.0F;
         }

         for(var23 = 0; this.field_70177_z - this.field_70126_B < -180.0F && var23 < 20; ++var23) {
