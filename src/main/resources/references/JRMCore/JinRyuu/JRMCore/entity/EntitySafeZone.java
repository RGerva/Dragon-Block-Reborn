...
public class EntitySafeZone extends EntityJRMC implements IEntityAdditionalSpawnData {
   ...
   public boolean isMostLikelyMe(Entity entity) {
      if (entity instanceof EntitySafeZone) {
         ...
         if (zone.getClass().toString().equals(this.getClass().toString()) && this.name.equals(zone.name) && this.duplicatesRadius == zone.duplicatesRadius && this.safezoneRadiusY == zone.safezoneRadiusY && this.safezoneRadiusXZ == zone.safezoneRadiusXZ && JGMathHelper.doubleSmallerThan(this.field_70165_t - zone.field_70165_t, 1.0D) && JGMathHelper.doubleSmallerThan(this.field_70163_u - zone.field_70163_u, 1.0D) && JGMathHelper.doubleSmallerThan(this.field_70161_v - zone.field_70161_v, 1.0D)) {
            return true;
         }
      }
      ...
      if (!this.field_70170_p.field_72995_K && this.field_70128_L) {
         ...
         if (!this.field_70170_p.field_72995_K) {
            ...
            if (r > 0) {
               ...
               AxisAlignedBB ab = AxisAlignedBB.func_72330_a(this.field_70165_t - (double)r, this.field_70163_u - (double)r, this.field_70161_v - (double)r, this.field_70165_t + (double)r, this.field_70163_u + (double)r, this.field_70161_v + (double)r);
               List list = this.field_70170_p.func_72839_b(this.field_70717_bb, ab);
   ...
   public void func_70636_d() {
      ...
      this.field_70170_p.field_72984_F.func_76319_b();
      EntityPlayer var2 = this.field_70170_p.func_72890_a(this, 8.0D);
   ...
   public void func_70625_a(Entity p_70625_1_, float p_70625_2_, float p_70625_3_) {
      ...
      if (p_70625_1_ instanceof EntityLivingBase) {
         ...
         d1 = entitylivingbase.field_70163_u + (double)(entitylivingbase.field_70131_O * 0.85F) - 1.600000023841858D - (this.field_70163_u + (double)this.func_70047_e());
      } else {
   ...
   public AxisAlignedBB createSafeZoneHitBox() {
      ...
      AxisAlignedBB ab2 = AxisAlignedBB.func_72330_a(this.field_70165_t - (double)r2XZ, this.field_70163_u - (double)r2Y, this.field_70161_v - (double)r2XZ, this.field_70165_t + (double)r2XZ, this.field_70163_u + (double)r2Y, this.field_70161_v + (double)r2XZ);
      return ab2;
   }

   public List createSafeZoneList() {
      AxisAlignedBB ab2 = this.createSafeZoneHitBox();
      List list = this.field_70170_p.func_72839_b(this, ab2);
      return list;
   }
